...
public class RepositoryUtil {
	...
	public static final String[] dbAccessTypeCode = { "Native", "ODBC", "OCI", "JNDI", };
	
//	public static void main(String[] args) throws KettleException {
//
//		Repository kRepository = new Repository();
...
//		kRepository.setDatabaseHost("192.168.0.9");
//		kRepository.setDatabasePort("3306");
//		kRepository.setDatabaseName("cde");
//		kRepository.setDatabaseUsername("cde");
//		kRepository.setDatabasePassword("cde");
//
//		KettleEnvironment.init();
//
//		KettleDatabaseRepository kettleDatabaseRepository = connectionRepository(kRepository);
//
//		List<RepositoryTreeForm> allRepositoryTreeList = new ArrayList<RepositoryTreeForm>();
//
//		List<RepositoryTreeForm> repositoryTreeList = getAllDirectoryTreeList(kettleDatabaseRepository, "/", allRepositoryTreeList);
//
...
//	}
	...
	public static String[] getDataBaseAccess(){
		String[] dataBaseAccess = dbAccessTypeCode;
	 ...
	 * @return void
	 */
	public static KettleDatabaseRepository connectionRepository(Repository kRepository) throws KettleException {
		if (null != kRepository){
			//数据库连接元对象
